...
func (c *userServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*BaseResponse, error) {
...
func (UnimplementedUserServiceServer) Register(context.Context, *RegisterRequest) (*BaseResponse, error) {
